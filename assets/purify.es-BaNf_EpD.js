...
const { entries: yt, setPrototypeOf: mt, isFrozen: Kt, getPrototypeOf: Zt, getOwnPropertyDescriptor: Jt } = Object;
let { freeze: y, seal: N, create: X } = Object, { apply: Fe, construct: He } = typeof Reflect < "u" && Reflect;
y || (y = function(n) {
  return n;
});
N || (N = function(n) {
...
function I(i) {
  const n = X(null);
  for (const [l, a] of yt(i)) u(i, l) && (O(a) ? n[l] = an(a) : a && typeof a == "object" && a.constructor === Object ? n[l] = I(a) : n[l] = a);
  return n;
}
function sn(i) {
  switch (typeof i) {
...
var Rt = Object.freeze({ __proto__: null, ARIA_ATTR: dn, ATTR_WHITESPACE: En, CUSTOM_ELEMENT: An, DATA_ATTR: Tn, DOCTYPE_NAME: Dt, ERB_EXPR: mn, IS_ALLOWED_URI: bt, IS_SCRIPT_OR_DATA: _n, MUSTACHE_EXPR: un, TMPLIT_EXPR: pn });
const oe = { element: 1, text: 3, progressingInstruction: 7, comment: 8, document: 9 }, gn = function() {
  ...
  try {
    return n.createPolicy(b, { createHTML(H) {
      return H;
    }, createScriptURL(H) {
      return H;
    } });
...
function It() {
  ...
  const n = (r) => It(r);
  if (n.version = "3.4.2", n.removed = [], !i || !i.document || i.document.nodeType !== oe.document || !i.Element) return n.isSupported = false, n;
  let { document: l } = i;
  const a = l, f = a.currentScript, { DocumentFragment: b, HTMLTemplateElement: H, Node: Ee, Element: ze, NodeFilter: V, NamedNodeMap: Lt = i.NamedNodeMap || i.MozNamedAttrMap, HTMLFormElement: Nt, DOMParser: Ct, trustedTypes: re } = i, $ = ze.prototype, Mt = j($, "cloneNode"), wt = j($, "remove"), Pt = j($, "nextSibling"), xt = j($, "childNodes"), ae = j($, "parentNode");
  if (typeof H == "function") {
    const r = l.createElement("template");
    r.content && r.content.ownerDocument && (l = r.content.ownerDocument);
  }
  let S, q = "";
  const { implementation: Ae, createNodeIterator: kt, createDocumentFragment: Ut, getElementsByTagName: vt } = l, { importNode: Ft } = a;
  let R = Ot();
  n.isSupported = typeof yt == "function" && typeof ae == "function" && Ae && Ae.createHTMLDocument !== void 0;
  const { MUSTACHE_EXPR: se, ERB_EXPR: le, TMPLIT_EXPR: ce, DATA_ATTR: Ht, ARIA_ATTR: zt, IS_SCRIPT_OR_DATA: Gt, ATTR_WHITESPACE: Ge, CUSTOM_ELEMENT: Bt } = Rt;
  let { IS_ALLOWED_URI: Be } = Rt, _ = null;
  const We = s({}, [...At, ...xe, ...ke, ...Ue, ...gt]);
  let A = null;
  const Ye = s({}, [...ht, ...ve, ...St, ..._e]);
  let m = Object.seal(X(null, { tagNameCheck: { writable: true, configurable: false, enumerable: true, value: null }, attributeNameCheck: { writable: true, configurable: false, enumerable: true, value: null }, allowCustomizedBuiltInElements: { writable: true, configurable: false, enumerable: true, value: false } })), K = null, fe = null;
  const k = Object.seal(X(null, { tagCheck: { writable: true, configurable: false, enumerable: true, value: null }, attributeCheck: { writable: true, configurable: false, enumerable: true, value: null } }));
  let Xe = true, ge = true, je = false, Ve = true, U = false, Z = true, v = false, he = false, Se = false, z = false, ue = false, me = false, $e = true, qe = false;
  const Ke = "user-content-";
  let Re = true, J = false, G = {}, w = null;
  ...
  const Vt = l.createElement("form"), et = function(e) {
    ...
    if (W && W === e) return;
    (!e || typeof e != "object") && (e = {}), e = I(e), Q = Xt.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? jt : e.PARSER_MEDIA_TYPE, d = Q === "application/xhtml+xml" ? Pe : ie, _ = u(e, "ALLOWED_TAGS") && O(e.ALLOWED_TAGS) ? s({}, e.ALLOWED_TAGS, d) : We, A = u(e, "ALLOWED_ATTR") && O(e.ALLOWED_ATTR) ? s({}, e.ALLOWED_ATTR, d) : Ye, De = u(e, "ALLOWED_NAMESPACES") && O(e.ALLOWED_NAMESPACES) ? s({}, e.ALLOWED_NAMESPACES, Pe) : Wt, ye = u(e, "ADD_URI_SAFE_ATTR") && O(e.ADD_URI_SAFE_ATTR) ? s(I(Qe), e.ADD_URI_SAFE_ATTR, d) : Qe, Ze = u(e, "ADD_DATA_URI_TAGS") && O(e.ADD_DATA_URI_TAGS) ? s(I(Je), e.ADD_DATA_URI_TAGS, d) : Je, w = u(e, "FORBID_CONTENTS") && O(e.FORBID_CONTENTS) ? s({}, e.FORBID_CONTENTS, d) : Oe, K = u(e, "FORBID_TAGS") && O(e.FORBID_TAGS) ? s({}, e.FORBID_TAGS, d) : I({}), fe = u(e, "FORBID_ATTR") && O(e.FORBID_ATTR) ? s({}, e.FORBID_ATTR, d) : I({}), G = u(e, "USE_PROFILES") ? e.USE_PROFILES && typeof e.USE_PROFILES == "object" ? I(e.USE_PROFILES) : e.USE_PROFILES : false, Xe = e.ALLOW_ARIA_ATTR !== false, ge = e.ALLOW_DATA_ATTR !== false, je = e.ALLOW_UNKNOWN_PROTOCOLS || false, Ve = e.ALLOW_SELF_CLOSE_IN_ATTR !== false, U = e.SAFE_FOR_TEMPLATES || false, Z = e.SAFE_FOR_XML !== false, v = e.WHOLE_DOCUMENT || false, z = e.RETURN_DOM || false, ue = e.RETURN_DOM_FRAGMENT || false, me = e.RETURN_TRUSTED_TYPE || false, Se = e.FORCE_BODY || false, $e = e.SANITIZE_DOM !== false, qe = e.SANITIZE_NAMED_PROPS || false, Re = e.KEEP_CONTENT !== false, J = e.IN_PLACE || false, Be = ln(e.ALLOWED_URI_REGEXP) ? e.ALLOWED_URI_REGEXP : bt, B = typeof e.NAMESPACE == "string" ? e.NAMESPACE : P, Ie = u(e, "MATHML_TEXT_INTEGRATION_POINTS") && e.MATHML_TEXT_INTEGRATION_POINTS && typeof e.MATHML_TEXT_INTEGRATION_POINTS == "object" ? I(e.MATHML_TEXT_INTEGRATION_POINTS) : s({}, ["mi", "mo", "mn", "ms", "mtext"]), Le = u(e, "HTML_INTEGRATION_POINTS") && e.HTML_INTEGRATION_POINTS && typeof e.HTML_INTEGRATION_POINTS == "object" ? I(e.HTML_INTEGRATION_POINTS) : s({}, ["annotation-xml"]);
    ...
    if (m = X(null), u(t, "tagNameCheck") && et(t.tagNameCheck) && (m.tagNameCheck = t.tagNameCheck), u(t, "attributeNameCheck") && et(t.attributeNameCheck) && (m.attributeNameCheck = t.attributeNameCheck), u(t, "allowCustomizedBuiltInElements") && typeof t.allowCustomizedBuiltInElements == "boolean" && (m.allowCustomizedBuiltInElements = t.allowCustomizedBuiltInElements), U && (ge = false), ue && (z = true), G && (_ = s({}, gt), A = X(null), G.html === true && (s(_, At), s(A, ht)), G.svg === true && (s(_, xe), s(A, ve), s(A, _e)), G.svgFilters === true && (s(_, ke), s(A, ve), s(A, _e)), G.mathMl === true && (s(_, Ue), s(A, St), s(A, _e))), k.tagCheck = null, k.attributeCheck = null, u(e, "ADD_TAGS") && (typeof e.ADD_TAGS == "function" ? k.tagCheck = e.ADD_TAGS : O(e.ADD_TAGS) && (_ === We && (_ = I(_)), s(_, e.ADD_TAGS, d))), u(e, "ADD_ATTR") && (typeof e.ADD_ATTR == "function" ? k.attributeCheck = e.ADD_ATTR : O(e.ADD_ATTR) && (A === Ye && (A = I(A)), s(A, e.ADD_ATTR, d))), u(e, "ADD_URI_SAFE_ATTR") && O(e.ADD_URI_SAFE_ATTR) && s(ye, e.ADD_URI_SAFE_ATTR, d), u(e, "FORBID_CONTENTS") && O(e.FORBID_CONTENTS) && (w === Oe && (w = I(w)), s(w, e.FORBID_CONTENTS, d)), u(e, "ADD_FORBID_CONTENTS") && O(e.ADD_FORBID_CONTENTS) && (w === Oe && (w = I(w)), s(w, e.ADD_FORBID_CONTENTS, d)), Re && (_["#text"] = true), v && s(_, ["html", "head", "body"]), _.table && (s(_, ["tbody"]), delete K.tbody), e.TRUSTED_TYPES_POLICY) {
    ...
    try {
      te(n.removed, { attribute: t.getAttributeNode(e), from: t });
    } catch {
      te(n.removed, { attribute: null, from: t });
    }
    if (t.removeAttribute(e), e === "is") if (z || ue) try {
      C(t);
    } catch {
    }
    else try {
    ...
    if (B === P) try {
      t = new Ct().parseFromString(c, Q);
    } catch {
    }
    if (!t || !t.documentElement) {
      t = Ae.createDocument(B, "template", null);
      try {
        t.documentElement.innerHTML = be ? q : c;
      } catch {
      }
    }
  ...
  const rt = function(e) {
    let t = null;
    if (x(R.beforeSanitizeElements, e, null), Ce(e)) return C(e), true;
    const o = d(e.nodeName);
    if (x(R.uponSanitizeElement, e, { tagName: o, allowedTags: _ }), Z && e.hasChildNodes() && !Me(e.firstElementChild) && g(/<[/\w!]/g, e.innerHTML) && g(/<[/\w!]/g, e.textContent) || Z && e.namespaceURI === P && o === "style" && Me(e.firstElementChild) || e.nodeType === oe.progressingInstruction || Z && e.nodeType === oe.comment && g(/<[/\w]/g, e.data)) return C(e), true;
    if (K[o] || !(k.tagCheck instanceof Function && k.tagCheck(o)) && !_[o]) {
      if (!K[o] && st(o) && (m.tagNameCheck instanceof RegExp && g(m.tagNameCheck, o) || m.tagNameCheck instanceof Function && m.tagNameCheck(o))) return false;
      if (Re && !w[o]) {
        const c = ae(e) || e.parentNode, h = xt(e) || e.childNodes;
        if (h && c) {
          const p = h.length;
          for (let D = p - 1; D >= 0; --D) {
            const L = Mt(h[D], true);
            c.insertBefore(L, Pt(e));
          }
        }
      }
      return C(e), true;
    }
    return e instanceof ze && !$t(e) || (o === "noscript" || o === "noembed" || o === "noframes") && g(/<\/no(script|embed|frames)/i, e.innerHTML) ? (C(e), true) : (U && e.nodeType === oe.text && (t = e.textContent, ee([se, le, ce], (c) => {
      t = Y(t, c, " ");
    }), e.textContent !== t && (te(n.removed, { element: e.cloneNode() }), e.textContent = t)), x(R.afterSanitizeElements, e, null), false);
  }, at = function(e, t, o) {
    if (fe[t] || $e && (t === "id" || t === "name") && (o in l || o in Vt)) return false;
    const c = A[t] || k.attributeCheck instanceof Function && k.attributeCheck(t, e);
    if (!(ge && !fe[t] && g(Ht, t))) {
      if (!(Xe && g(zt, t))) {
        if (!c || fe[t]) {
          if (!(st(e) && (m.tagNameCheck instanceof RegExp && g(m.tagNameCheck, e) || m.tagNameCheck instanceof Function && m.tagNameCheck(e)) && (m.attributeNameCheck instanceof RegExp && g(m.attributeNameCheck, t) || m.attributeNameCheck instanceof Function && m.attributeNameCheck(t, e)) || t === "is" && m.allowCustomizedBuiltInElements && (m.tagNameCheck instanceof RegExp && g(m.tagNameCheck, o) || m.tagNameCheck instanceof Function && m.tagNameCheck(o)))) return false;
        } else if (!ye[t]) {
          if (!g(Be, Y(o, Ge, ""))) {
    ...
    if (!t || Ce(e)) return;
    const o = { attrName: "", attrValue: "", keepAttr: true, allowedAttributes: A, forceKeepAttr: void 0 };
    let c = t.length;
    for (; c--; ) {
      const h = t[c], { name: p, namespaceURI: D, value: L } = h, M = d(p), we = L;
      let E = p === "value" ? we : tn(we);
      if (o.attrName = M, o.attrValue = E, o.keepAttr = true, o.forceKeepAttr = void 0, x(R.uponSanitizeAttribute, e, o), E = o.attrValue, qe && (M === "id" || M === "name") && dt(E, Ke) !== 0 && (F(p, e), E = Ke + E), Z && g(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i, E)) {
        F(p, e);
        continue;
      }
    ...
    let t = null;
    const o = it(e);
    for (x(R.beforeSanitizeShadowDOM, e, null); t = o.nextNode(); ) x(R.uponSanitizeShadowNode, t, null), rt(t), lt(t), t.content instanceof b && ct(t.content);
  ...
  return n.sanitize = function(r) {
    ...
    if (be = !r, be && (r = "<!-->"), typeof r != "string" && !Me(r) && (r = sn(r), typeof r != "string")) throw de("dirty is not a string, aborting");
    if (!n.isSupported) return r;
    if (he || Ne(e), n.removed = [], typeof r == "string" && (J = false), J) {
      const L = r.nodeName;
      if (typeof L == "string") {
        const M = d(L);
        if (!_[M] || K[M]) throw de("root node is forbidden and cannot be sanitized in-place");
      }
    } else if (r instanceof Ee) t = ot("<!---->"), o = t.ownerDocument.importNode(r, true), o.nodeType === oe.element && o.nodeName === "BODY" || o.nodeName === "HTML" ? t = o : t.appendChild(o);
    else {
      if (!z && !U && !v && r.indexOf("<") === -1) return S && me ? S.createHTML(r) : r;
    ...
    if (z) {
      ...
      if (ue) for (h = Ut.call(t.ownerDocument); t.firstChild; ) h.appendChild(t.firstChild);
      else h = t;
